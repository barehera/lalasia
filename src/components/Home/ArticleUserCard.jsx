...
const ArticleUserCard = ({
  ...
  return (
    <article className="grid grid-cols-12 lg:grid-cols-2 items-center gap-7 ">
      <div className="col-span-4 lg:col-span-1">
        <img
          src={image}
          alt={category}
          className="w-full h-32 object-fill lg:h-auto lg:w-auto"
        />
      </div>
      ...
      <div className="col-span-8 lg:col-span-1">
        ...
        <div className="flex items-center justify-between">
          ...
          <p className="text-paragraph text-[0.7rem] lg:text-sm">{date}</p>
        </div>
      </div>
    </article>
  );
